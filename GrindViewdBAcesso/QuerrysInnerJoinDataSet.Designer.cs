...
namespace GrindViewdBAcesso.QuerrysInnerJoinDataSetTableAdapters {
...
SELECT Id, Modelo, Ano, Marca, Ativo, UsuInc, UsuAlt, DatInc, DatAlt FROM Carros WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GrindViewdBAcesso.Properties.Settings.Default.QuerrysInnerJoinConnectionString;
        }
        ...
        public virtual int Fill(QuerrysInnerJoinDataSet.CarrosDataTable dataTable) {
...
SELECT Id, Nome, Ativo, UsuInc, UsuAlt, DatInc, DatAlt FROM Marcas WHERE (Id = @Id)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(QuerrysInnerJoinDataSet.MarcasDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
